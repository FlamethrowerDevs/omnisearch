...
def dosearch(query, config):
    ...
    try:
        ...
        config = {"sorters": ["Fuzzy Match"], "filters": [], "searchers": ["The Eyedex", "Local Archive", "YTS/YIFY", "Game Repackers", "Opendirectory Indexes"]} # default config for when i break things
    user_searchers = []
    user_filters   = []
    user_sorters   = []
